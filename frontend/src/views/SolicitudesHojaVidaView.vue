...
<style scoped>
.content-wrapper{flex:1;min-width:0;padding:2rem;background:var(--cr-gray-100);min-height:100vh}.content-header{margin-bottom:1.25rem}.request-shell{background:var(--cr-white);border-radius:18px;padding:1.4rem;box-shadow:0 10px 30px rgba(20,32,50,.08)}.request-toolbar{display:flex;justify-content:space-between;gap:1rem;align-items:center;margin-bottom:1.2rem}.request-toolbar h2{margin:0 0 .25rem}.request-toolbar p{margin:0;color:var(--cr-slate)}.request-toolbar select{max-width:220px}.request-list{display:grid;gap:1rem}.request-card{border:1px solid #e3e8ef;border-radius:15px;padding:1.15rem}.request-card__header{display:flex;justify-content:space-between;gap:1rem}.request-card h3{margin:.45rem 0 .2rem}.request-card p{color:var(--cr-slate)}.status-badge{font-size:.75rem;text-transform:uppercase;font-weight:800;padding:.3rem .55rem;border-radius:999px;background:#fff1c2;color:#805b00}.status-badge--aprobada{background:#dff7e8;color:#176b3a}.status-badge--rechazada{background:#fde2e3;color:#a4212a}.data-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:.7rem;margin:1rem 0}.data-grid div{background:var(--cr-gray-50);border-radius:10px;padding:.7rem}.data-grid dt{font-size:.75rem;color:var(--cr-slate);text-transform:uppercase}.data-grid dd{margin:.2rem 0 0;font-weight:700}.attachment-list{display:flex;flex-wrap:wrap;gap:.6rem}.attachment-list a{color:#c51f2b}.request-actions{display:flex;justify-content:flex-end;gap:.6rem;margin-top:1rem}.review-reason{background:#fff5f5;padding:.75rem;border-radius:10px}.empty-state{text-align:center;padding:2rem;color:var(--cr-slate)}@media(max-width:768px){.content-wrapper{padding:6.5rem 1rem 1rem}.request-toolbar{align-items:stretch;flex-direction:column}.request-toolbar select{max-width:none}}
</style>
