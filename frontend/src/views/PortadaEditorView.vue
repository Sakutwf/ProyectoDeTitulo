      ...
      <div v-else class="editor-sections">
        ...
        <section class="editor-panel">
          ...
          <div class="form-grid">
            ...
            <label>WhatsApp de la filial<input v-model="texts.whatsapp" class="form-control" maxlength="40" placeholder="Ej.: +56 9 8765 4321"></label>
...
<style scoped>
.portada-editor{padding:1.5rem;background:#f4f6f9;min-height:100vh}.editor-header{display:flex;justify-content:space-between;gap:1rem;align-items:center;margin-bottom:1.5rem}.editor-header p,.panel-heading span,.gallery-modal header p,.preview-modal header p{margin:0;color:var(--cr-red);font-weight:800;text-transform:uppercase;letter-spacing:.12em;font-size:.75rem}.editor-header h1{margin:.2rem 0;color:var(--cr-navy-deep);font-weight:800}.editor-sections{display:grid;gap:1.5rem}.editor-panel{background:var(--cr-white);border-radius:24px;padding:1.3rem;box-shadow:0 12px 30px rgba(1,30,65,.07)}.panel-heading,.card-toolbar{display:flex;justify-content:space-between;gap:1rem;align-items:center}.panel-heading h2{margin:.15rem 0;color:var(--cr-navy-deep)}.panel-heading p{margin:0;color:var(--cr-slate)}.editor-list{display:grid;gap:1rem;margin-top:1.2rem}.editor-card{border:1px solid #e3e7ee;border-radius:18px;padding:1rem}.card-toolbar{margin-bottom:1rem}.icon-button{border:0;background:#eef1f5;color:var(--cr-navy-soft);border-radius:9px;width:34px;height:34px;margin-left:.3rem}.icon-button--danger{color:var(--cr-red-muted)}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}.form-grid--three{grid-template-columns:repeat(3,minmax(0,1fr))}.form-grid label,.image-slot{font-weight:700;color:var(--cr-slate-dark)}.form-control,.form-select{margin-top:.35rem}.image-picker-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem;margin-top:1rem}.image-select-button,.cover-picker{width:100%;height:150px;margin-top:.4rem;border:1px dashed #aab3c2;border-radius:14px;background:#f7f8fa;overflow:hidden;padding:0;color:#526074}.image-select-button img,.cover-picker img{width:100%;height:100%;object-fit:cover}.image-select-button span,.cover-picker span{display:flex;height:100%;align-items:center;justify-content:center;gap:.5rem}.remove-image{border:0;background:none;color:var(--cr-red-muted);font-size:.8rem;margin-top:.3rem}.field-options{display:flex;flex-wrap:wrap;gap:1rem;margin-top:1rem;padding:.8rem;background:#f7f8fa;border-radius:12px}.field-options span{font-weight:800}.empty-note,.editor-state{padding:2rem;text-align:center;color:var(--cr-slate)}.modal-layer{position:fixed;inset:0;z-index:3000;background:rgba(1,18,38,.72);display:grid;place-items:center;padding:1rem}.gallery-modal,.preview-modal{width:min(1100px,96vw);max-height:92vh;background:var(--cr-white);border-radius:24px;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 30px 80px rgba(0,0,0,.3)}.gallery-modal header,.preview-modal header{display:flex;align-items:center;justify-content:space-between;padding:1.2rem 1.4rem;border-bottom:1px solid #e6e9ef}.gallery-modal h2,.preview-modal h2{margin:.15rem 0 0;color:var(--cr-navy-deep)}.modal-close{border:0;background:#eef1f5;width:40px;height:40px;border-radius:50%;font-size:1.15rem}.gallery-filters{display:grid;grid-template-columns:320px 1fr;gap:1rem;padding:1rem 1.4rem}.search-box{position:relative}.search-box i{position:absolute;left:1rem;top:50%;transform:translateY(-40%);color:#778195}.search-box input{padding-left:2.7rem}.gallery-results{padding:0 1.4rem 1.4rem;overflow:auto;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem}.gallery-photo{padding:0;border:1px solid #e1e5eb;border-radius:15px;background:var(--cr-white);overflow:hidden;text-align:left;transition:.2s}.gallery-photo:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(1,30,65,.14);border-color:var(--cr-red)}.gallery-photo>img{width:100%;height:155px;object-fit:cover}.gallery-photo>span{display:grid;padding:.75rem;gap:.15rem}.gallery-photo small{color:var(--cr-gray-500);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gallery-empty{grid-column:1/-1;text-align:center;padding:4rem;color:var(--cr-gray-500)}.gallery-empty i{font-size:2.5rem}.preview-content{overflow:auto;padding:1.3rem}.preview-content>h3{margin:1.5rem 0 1rem}@media(max-width:900px){.editor-header,.panel-heading{align-items:flex-start;flex-direction:column}.form-grid,.form-grid--three,.image-picker-grid{grid-template-columns:1fr}.gallery-filters,.gallery-results{grid-template-columns:1fr}.gallery-results{grid-template-columns:repeat(2,minmax(0,1fr))}}
.draggable-image{position:relative;display:block;width:100%;height:auto;min-height:110px;margin-top:.4rem;border-radius:14px;overflow:hidden;background:#e9edf2;cursor:grab;touch-action:none;user-select:none}.draggable-image:active{cursor:grabbing}.draggable-image>img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;pointer-events:none;user-select:none}.drag-hint{position:absolute;left:50%;bottom:.55rem;transform:translateX(-50%);display:flex!important;align-items:center;gap:.35rem;padding:.35rem .65rem;border-radius:999px;background:rgba(1,30,65,.78);color:var(--cr-white);font-size:.72rem;white-space:nowrap;pointer-events:none}.change-image{border:0;background:#eef2f6;color:var(--cr-navy-soft);border-radius:8px;padding:.35rem .55rem;font-size:.78rem;margin-top:.4rem}.editor-footer{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1.3rem 1.5rem;background:var(--cr-white);border:1px solid #e1e5eb;border-radius:20px;box-shadow:0 12px 28px rgba(1,30,65,.08)}.editor-footer>div:first-child{display:grid;gap:.2rem}.editor-footer span{color:var(--cr-gray-500)}.editor-footer__actions{display:flex;gap:.7rem}@media(max-width:700px){.editor-footer{align-items:stretch;flex-direction:column}.editor-footer__actions{display:grid;grid-template-columns:1fr}.editor-footer__actions .btn{width:100%}}
.portada-editor{display:grid;grid-template-columns:minmax(620px,1fr) minmax(430px,.95fr);align-items:start;gap:1.5rem;max-width:none!important;width:100%}.editor-column{min-width:0}.section-preview-action{display:flex;justify-content:flex-end;margin-top:1.2rem;padding-top:1rem;border-top:1px solid #e7eaf0}.live-preview-panel{position:sticky;top:1.5rem;height:calc(100vh - 3rem);min-width:0;background:#17243a;border-radius:24px;padding:.8rem;display:flex;flex-direction:column;box-shadow:0 20px 50px rgba(1,30,65,.2)}.live-preview-panel>header{display:flex;align-items:center;justify-content:space-between;padding:.7rem .8rem 1rem;color:var(--cr-white)}.live-preview-panel>header p{margin:0;color:#ff9ba2;font-size:.68rem;font-weight:800;text-transform:uppercase;letter-spacing:.12em}.live-preview-panel>header h2{margin:.1rem 0 0;font-size:1.15rem}.live-preview-panel>header>span{padding:.3rem .6rem;border-radius:99px;background:rgba(255,255,255,.12);font-size:.72rem}.live-preview-viewport{flex:1;min-height:0;overflow-y:auto;scroll-behavior:smooth;border-radius:16px;background:#f5f6f8;scrollbar-width:thin}.mini-page{min-height:100%;background:#f6f7f9;color:var(--cr-navy-deep)}.mini-hero{position:relative;width:100%;height:auto;aspect-ratio:4.36;background:#dfe4eb;overflow:hidden}.mini-hero__images{position:absolute;inset:0;display:grid;gap:2px}.mini-hero__images img{width:100%;height:100%;min-width:0;object-fit:cover}.mini-hero::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(1,30,65,.72),transparent 80%);pointer-events:none}.mini-hero__copy{position:absolute;z-index:2;left:1.4rem;right:1.4rem;bottom:1rem;color:var(--cr-white)}.mini-hero__copy small,.mini-intro small{color:#ffbbc0;text-transform:uppercase;letter-spacing:.12em;font-weight:800}.mini-hero__copy h1{margin:.2rem 0;font-size:1.25rem;line-height:1}.mini-hero__copy p{margin:0;font-size:.7rem}.mini-intro{text-align:center;padding:1.8rem 1rem 1rem}.mini-intro small{color:var(--cr-red-muted)}.mini-intro h2{margin:.3rem 0;font-size:1.4rem}.mini-intro p{margin:0;color:#657184;font-size:.75rem}.mini-news{padding:.7rem 1.2rem 2rem;display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:.65rem}.mini-news article{grid-column:span 2;background:var(--cr-white);border-radius:12px;overflow:hidden;box-shadow:0 8px 20px rgba(1,30,65,.08)}.mini-news article.mini-news--mitad{grid-column:span 3}.mini-news article.mini-news--completo{grid-column:span 6;display:grid;grid-template-columns:38% 1fr}.mini-news article>img{width:100%;height:75px;object-fit:cover}.mini-news article.mini-news--completo>img{height:100%}.mini-news article>div{padding:.6rem}.mini-news article small{color:var(--cr-red-muted);text-transform:uppercase;font-weight:800;font-size:.55rem}.mini-news article h3{margin:.2rem 0;font-size:.8rem}.mini-news article p{margin:0;color:#657184;font-size:.62rem;line-height:1.35}.mini-placeholder{position:absolute;inset:0;z-index:2;display:grid;place-content:center;justify-items:center;gap:.5rem;color:#708096;background:#e9edf2}.mini-placeholder i{font-size:2rem}.mini-placeholder--news{position:relative;grid-column:1/-1;min-height:100px;border-radius:14px}.preview-navigation{position:absolute;right:1.1rem;top:50%;transform:translateY(-50%);display:grid;gap:.45rem;z-index:4}.preview-navigation button{width:38px;height:38px;border:1px solid rgba(255,255,255,.3);border-radius:50%;background:rgba(1,30,65,.82);color:var(--cr-white);box-shadow:0 5px 12px rgba(0,0,0,.2)}@media(max-width:1350px){.portada-editor{grid-template-columns:minmax(560px,1fr) minmax(370px,.75fr)}.form-grid--three{grid-template-columns:1fr 1fr}}@media(max-width:1050px){.portada-editor{display:block}.live-preview-panel{position:relative;top:auto;height:720px;margin-top:1.5rem}.form-grid--three{grid-template-columns:1fr}.section-preview-action .btn{width:100%}}
.image-picker-grid .image-select-button{height:auto;min-height:110px}
.zoom-controls{position:absolute;top:.5rem;right:.5rem;z-index:3;display:flex!important;align-items:center;gap:.3rem;padding:.25rem;border-radius:999px;background:rgba(1,30,65,.86);color:var(--cr-white);font-size:.7rem}.zoom-controls button{width:27px;height:27px;border:0;border-radius:50%;background:var(--cr-white);color:var(--cr-navy-deep);display:grid;place-items:center}.zoom-controls button:disabled{opacity:.4}.zoom-controls strong{min-width:38px;text-align:center}.mini-image-cell{display:block;min-width:0;height:100%;overflow:hidden}.mini-image-cell img{width:100%;height:100%;object-fit:cover}
...
.footer-editor-block{margin-top:1.4rem;padding-top:1.2rem;border-top:1px solid #e6e9ef}.subsection-heading{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:.8rem}.subsection-heading h3{margin:0;font-size:1rem;color:var(--cr-navy-deep)}.subsection-heading p{margin:.2rem 0 0;color:var(--cr-gray-500);font-size:.85rem}.directory-editor-list{display:grid;gap:.65rem}.directory-editor-row{display:grid;grid-template-columns:minmax(180px,1fr) minmax(180px,1fr) auto;align-items:center;gap:.65rem}.mini-footer{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));column-gap:clamp(.6rem,1.5vw,1rem);row-gap:.65rem;padding:.8rem 1rem;background:var(--cr-white);border-top:3px solid var(--cr-red)}.mini-footer h3{font-size:.66rem;text-transform:uppercase;margin:.35rem 0 .1rem}.mini-footer__contact{display:flex;flex-direction:column;align-items:flex-start;gap:.18rem}.mini-footer__contact>a{font-size:.55rem;color:var(--cr-white);text-decoration:none;line-height:1.3}.mini-socials{display:flex;gap:.25rem}.mini-socials a{width:23px!important;height:23px;border-radius:50%;display:grid!important;place-items:center;background:var(--cr-white);color:var(--cr-red)!important;font-size:.6rem;padding:0!important}.mini-footer__related{display:flex;flex-direction:column;align-items:flex-start;width:100%;gap:.25rem}.mini-footer__related>a{font-size:.52rem;color:var(--cr-gray-500);overflow:hidden;text-overflow:ellipsis}@media(max-width:700px){.directory-editor-row{grid-template-columns:1fr}.mini-footer{grid-template-columns:1fr}.mini-footer__related{width:100%}}.mini-footer{background:var(--cr-red);color:var(--cr-white);border-top-color:#b5121b}.mini-footer h3,.mini-footer strong,.mini-footer span,.mini-footer a,.mini-footer article small{color:var(--cr-white)}.mini-socials a{background:var(--cr-white);color:var(--cr-red)}@media(max-width:700px){}
.mini-footer__contact>p{margin:0;white-space:pre-line;font-size:.58rem;line-height:1.4;color:var(--cr-white)}
.mini-contact-links{display:grid;gap:.2rem;margin:.15rem 0 .35rem}.mini-contact-links a{font-size:.55rem;color:var(--cr-white);text-decoration:none}.mini-contact-links i{width:12px}
.device-upload-row{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin:1rem 1.4rem 0;padding:1rem 1.1rem;border:1px dashed var(--cr-red);border-radius:14px;background:#fff6f6}.device-upload-row>div{display:grid;gap:.15rem;color:var(--cr-slate-dark)}.device-upload-row span{color:var(--cr-gray-500);font-size:.8rem}@media(max-width:700px){.device-upload-row{align-items:stretch;flex-direction:column}.device-upload-row .btn{width:100%}}
.gallery-photo>img{height:auto;aspect-ratio:1/1;object-fit:contain;object-position:50% 50%;background:#eef1f5}.gallery-pagination{display:flex;align-items:center;justify-content:center;gap:1rem;padding:.8rem 1.4rem 1.1rem;border-top:1px solid #e6e9ef;color:#526074}.gallery-pagination button{width:38px;height:38px;border:1px solid #d8dee7;border-radius:50%;background:var(--cr-white);color:var(--cr-navy-soft)}.gallery-pagination button:not(:disabled):hover{border-color:var(--cr-red);color:var(--cr-red)}.gallery-pagination button:disabled{opacity:.35}.gallery-pagination span{font-size:.85rem}
.mini-intro{padding:1.8rem 1rem 1rem;background:var(--cr-white)}.mini-hero{background:var(--cr-red)}.mini-news article{background:var(--cr-red);color:var(--cr-white)}.mini-news article small,.mini-news article h3,.mini-news article p{color:var(--cr-white)}
.mini-footer a:visited{color:var(--cr-white)}.mini-footer a:hover,.mini-footer a:focus{color:#ffe3e5}.mini-footer .mini-socials a:visited{color:var(--cr-red)}
...
.mini-hero__copy small{color:var(--carousel-label-color,var(--cr-white))!important}.mini-hero__copy h1{color:var(--carousel-title-color,var(--cr-white))!important}.mini-hero__copy p{color:var(--carousel-subtitle-color,var(--cr-white))!important}.mini-intro small{color:var(--news-label-color,var(--cr-red-muted))!important}.mini-intro h2{color:var(--news-title-color,var(--cr-navy-deep))!important}.mini-intro p{color:var(--news-description-color,#657184)!important}
.color-label-row{display:flex;align-items:center;justify-content:space-between;gap:.7rem}.color-shortcut{display:inline-flex;align-items:center;gap:.4rem;flex:0 0 auto;padding:.3rem .55rem;border:1px solid #d8dee7;border-radius:999px;background:var(--cr-white);color:var(--cr-slate-dark);font-size:.72rem;font-weight:700}.color-shortcut:hover{border-color:var(--cr-red)}.color-shortcut i{width:20px;height:20px;border-radius:50%;border:1px solid rgba(1,30,65,.2);box-shadow:inset 0 0 0 2px var(--cr-white)}.color-modal{width:min(620px,96vw);max-height:90vh;background:var(--cr-white);border-radius:24px;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 30px 80px rgba(0,0,0,.3)}.color-modal>header{display:flex;align-items:flex-start;justify-content:space-between;padding:1.3rem 1.5rem;border-bottom:1px solid var(--cr-border)}.color-modal>header p{margin:0;color:var(--cr-red);font-weight:800;text-transform:uppercase;letter-spacing:.12em;font-size:.72rem}.color-modal>header h2{margin:.2rem 0;color:var(--cr-navy-deep)}.color-modal>header span{color:var(--cr-gray-500)}.color-modal__body{padding:1.3rem 1.5rem;overflow:auto}.color-modal__palette{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.7rem}.color-modal__palette>button{position:relative;display:flex;align-items:center;gap:.75rem;min-height:64px;padding:.65rem;border:1px solid #d9dee6;border-radius:14px;background:var(--cr-white);color:var(--cr-slate-dark);text-align:left}.color-modal__palette>button:hover,.color-modal__palette>button.active{border-color:var(--cr-red);box-shadow:0 0 0 2px rgba(224,30,30,.1)}.color-modal__palette>button>i:first-child{width:40px;height:40px;flex:0 0 auto;border-radius:10px;border:1px solid rgba(1,30,65,.18)}.color-modal__palette>button>span{display:grid}.color-modal__palette small{color:#7b8798;font-weight:500}.color-check{position:absolute;right:.8rem;color:var(--cr-red)}.custom-color-field{display:grid;gap:.5rem;margin-top:1.2rem;color:var(--cr-slate-dark);font-weight:700}.custom-color-field>span{display:grid;grid-template-columns:58px 1fr;gap:.7rem}.custom-color-field input[type=color]{width:58px;height:42px;padding:2px;border:1px solid #ced4da;border-radius:8px;background:var(--cr-white);cursor:pointer}.custom-color-field .form-control{margin:0;text-transform:uppercase}.color-modal>footer{display:flex;justify-content:flex-end;padding:1rem 1.5rem;border-top:1px solid var(--cr-border)}@media(max-width:600px){.color-modal__palette{grid-template-columns:1fr}}
.preview-content--landing{padding:0;background:#f6f7f9}.mini-site-header{min-height:58px;padding:.65rem 1rem;background:var(--cr-white);display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #e7e9ee}.mini-site-brand{display:flex;align-items:center;gap:.65rem;color:var(--cr-navy-deep)}.mini-site-brand>img{width:95px}.mini-site-brand>span{display:grid}.mini-site-brand small{text-transform:uppercase;letter-spacing:.12em;color:#7a8495;font-size:.48rem}.mini-site-brand strong{font-size:.63rem}.mini-profile-button{display:inline-flex;align-items:center;gap:.35rem;padding:.42rem .65rem;border-radius:999px;background:var(--cr-red);color:var(--cr-white);font-size:.58rem;font-weight:800}.mini-news{background:var(--cr-red)}.mini-news article,.mini-news article.mini-news--completo{background:var(--cr-white);color:var(--cr-navy-deep)}.mini-news article small,.mini-news article h3,.mini-news article p{color:inherit}.mini-news__image{display:block;min-width:0;overflow:hidden}.mini-news__image img{width:100%;height:100%;object-fit:cover}.mini-news--reverse .mini-news__image{order:2}.mini-news--reverse .mini-news__body{order:1}.mini-news__body{display:flex;flex-direction:column;justify-content:center}.mini-news__body>p{color:#596579!important}.mini-news dl{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.28rem .55rem;margin:.45rem 0 0}.mini-news dl div{padding-top:.3rem;border-top:1px solid #edf0f3}.mini-news dt{font-size:.45rem;text-transform:uppercase;color:#778195}.mini-news dt i{width:14px;color:var(--cr-red)}.mini-news dd{margin:.1rem 0 0;font-size:.56rem;font-weight:700;color:#596579}.mini-page--modal{font-size:1.35rem}.mini-page--modal .mini-site-header{min-height:76px;padding:.8rem 1.5rem}.mini-page--modal .mini-site-brand>img{width:145px}.mini-page--modal .mini-site-brand small{font-size:.55rem}.mini-page--modal .mini-site-brand strong{font-size:.8rem}.mini-page--modal .mini-profile-button{font-size:.72rem;padding:.55rem .85rem}.mini-page--modal .mini-hero{height:310px;aspect-ratio:auto}.mini-page--modal .mini-hero__copy{left:3rem;bottom:2rem}.mini-page--modal .mini-hero__copy h1{font-size:2rem}.mini-page--modal .mini-hero__copy p{font-size:.85rem}.mini-page--modal .mini-intro{padding:2.2rem 1rem 1.2rem}.mini-page--modal .mini-intro h2{font-size:2rem}.mini-page--modal .mini-intro p{font-size:.85rem}.mini-page--modal .mini-news{padding:1rem 2.5rem 2.5rem;gap:1rem}.mini-page--modal .mini-news article.mini-news--completo{min-height:210px;border-radius:18px}.mini-page--modal .mini-news article>div{padding:1.25rem}.mini-page--modal .mini-news article h3{font-size:1.25rem}.mini-page--modal .mini-news article p{font-size:.78rem}.mini-page--modal .mini-news dt{font-size:.58rem}.mini-page--modal .mini-news dd{font-size:.72rem}.mini-page--modal .mini-footer{padding:1.3rem 2rem}.mini-page--modal .mini-footer h3{font-size:.75rem}.mini-page--modal .mini-footer__contact>a,.mini-page--modal .mini-footer__contact>p,.mini-page--modal .mini-contact-links a,.mini-page--modal .mini-footer__related>a{font-size:.65rem}@media(max-width:700px){.mini-site-brand>span{display:none}.mini-page--modal{font-size:1rem}.mini-page--modal .mini-hero{height:220px}.mini-page--modal .mini-news{padding:1rem}.mini-page--modal .mini-news article.mini-news--completo,.mini-page--modal .mini-news article.mini-news--reverse{display:block;min-height:0}.mini-page--modal .mini-news__image{height:170px}.mini-page--modal .mini-news__image,.mini-page--modal .mini-news__body{order:initial}.mini-news dl{grid-template-columns:1fr}}
...
.mini-socials a{width:36px!important;height:36px;font-size:1.05rem}.mini-socials a i{font-size:1.05rem}.mini-page--modal .mini-socials a{width:54px!important;height:54px;font-size:1.55rem}.mini-page--modal .mini-socials a i{font-size:1.55rem}

/* La vista lateral representa un escritorio de 1920 px reducido al ancho disponible. */
.live-preview-viewport{container-type:inline-size}
.live-preview-viewport .mini-page{font-size:.833333cqw}
.live-preview-viewport .mini-site-header{height:4.270833cqw;min-height:4.270833cqw;padding:0 1.666667cqw}
.live-preview-viewport .mini-site-brand{gap:.833333cqw}
.live-preview-viewport .mini-site-brand>img{width:8.59375cqw}
.live-preview-viewport .mini-site-brand>span{display:grid}
.live-preview-viewport .mini-site-brand small{font-size:.625cqw;letter-spacing:.15em}
.live-preview-viewport .mini-site-brand strong{font-size:.833333cqw}
.live-preview-viewport .mini-profile-button{gap:.416667cqw;padding:.625cqw .916667cqw;font-size:.833333cqw}
.live-preview-viewport .mini-hero{height:17.708333cqw;aspect-ratio:auto}
.live-preview-viewport .mini-hero__images{gap:.15625cqw}
.live-preview-viewport .mini-hero__copy{left:5cqw;right:auto;bottom:2.916667cqw;width:35.416667cqw}
.live-preview-viewport .mini-hero__copy small{font-size:.833333cqw;letter-spacing:.16em}
.live-preview-viewport .mini-hero__copy h1{margin:.291667cqw 0;font-size:2.666667cqw}
.live-preview-viewport .mini-hero__copy p{font-size:.916667cqw}
.live-preview-viewport .mini-intro{padding:2.333333cqw 1.25cqw 1.166667cqw}
.live-preview-viewport .mini-intro small{font-size:.833333cqw;letter-spacing:.14em}
.live-preview-viewport .mini-intro h2{margin:.333333cqw 0;font-size:2.333333cqw}
.live-preview-viewport .mini-intro p{font-size:.833333cqw}
.live-preview-viewport .mini-news{padding:.583333cqw 3.333333cqw 2.5cqw;gap:.833333cqw}
.live-preview-viewport .mini-news article.mini-news--completo{min-height:9.895833cqw;border-radius:1.041667cqw;grid-template-columns:38% 1fr}
.live-preview-viewport .mini-news article.mini-news--reverse{grid-template-columns:1fr 38%}
.live-preview-viewport .mini-news article>div{padding:1.333333cqw}
.live-preview-viewport .mini-news article h3{margin:0 0 .541667cqw;font-size:1.666667cqw;line-height:1.08}
.live-preview-viewport .mini-news article p{font-size:.833333cqw;line-height:1.45}
.live-preview-viewport .mini-news dl{grid-template-columns:repeat(2,minmax(0,1fr));gap:.291667cqw .666667cqw;margin:.5cqw 0 0}
.live-preview-viewport .mini-news dl div{padding-top:.333333cqw}
.live-preview-viewport .mini-news dt{font-size:.566667cqw}
.live-preview-viewport .mini-news dt i{width:.989583cqw}
.live-preview-viewport .mini-news dd{margin:.125cqw 0 0;font-size:.708333cqw}
.live-preview-viewport .mini-footer{column-gap:2.083333cqw;row-gap:.958333cqw;padding:1.875cqw 2.5cqw;border-top-width:.208333cqw}
.live-preview-viewport .mini-footer h3{margin:0 0 .625cqw;font-size:.766667cqw}
.live-preview-viewport .mini-footer__contact{gap:.208333cqw}
.live-preview-viewport .mini-footer__contact>a,.live-preview-viewport .mini-footer__contact>p,.live-preview-viewport .mini-contact-links a,.live-preview-viewport .mini-footer__related>a{font-size:.708333cqw}
.live-preview-viewport .mini-socials{gap:.416667cqw}
.live-preview-viewport .mini-socials a{width:3.333333cqw!important;height:3.333333cqw;font-size:1.5625cqw}
.live-preview-viewport .mini-socials a i{font-size:1.5625cqw}
</style>
