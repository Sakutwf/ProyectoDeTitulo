...
<style scoped>
.welcome-shell{display:flex;min-height:100vh;background:#f2f5f8;color:var(--cr-navy-deep)}.welcome-page{flex:1;min-width:0;padding:clamp(1.5rem,4vw,4rem);background:radial-gradient(circle at 90% 0,rgba(224,30,30,.08),transparent 27%),#f2f5f8}.welcome-hero{display:flex;align-items:center;justify-content:space-between;gap:2rem;margin-bottom:2rem}.welcome-hero p,.section-heading p{margin:0;color:var(--cr-red-muted);font-size:.78rem;font-weight:800;letter-spacing:.13em;text-transform:uppercase}.welcome-hero p{text-transform:capitalize}.welcome-hero h1{margin:.35rem 0;color:var(--cr-navy-deep);font-size:clamp(2rem,4vw,3.4rem);font-weight:800}.welcome-hero>div>span,.section-heading>span{color:#637083}.public-home-link{display:inline-flex;align-items:center;gap:.55rem;flex:0 0 auto;padding:.8rem 1.1rem;border:1px solid #d9dfe8;border-radius:999px;background:var(--cr-white);color:var(--cr-navy-soft);text-decoration:none;font-weight:700}.profile-summary{display:grid;grid-template-columns:minmax(250px,.9fr) minmax(360px,1.4fr) auto;align-items:center;gap:clamp(1.3rem,3vw,3rem);padding:clamp(1.3rem,3vw,2.2rem);border:1px solid rgba(1,30,65,.08);border-radius:28px;background:var(--cr-white);box-shadow:0 18px 45px rgba(1,30,65,.08)}.profile-identity{display:flex;align-items:center;gap:1rem;min-width:0}.profile-identity>img,.profile-avatar{width:92px;height:92px;flex:0 0 auto;border-radius:24px;object-fit:cover;background:var(--cr-red);color:var(--cr-white);display:grid;place-items:center;font-size:1.7rem;font-weight:800}.profile-identity small{color:var(--cr-red-muted);font-weight:800;text-transform:uppercase;letter-spacing:.1em}.profile-identity h2{margin:.25rem 0 .5rem;font-size:1.45rem}.role-list{display:flex;flex-wrap:wrap;gap:.35rem}.role-list span{padding:.28rem .55rem;border-radius:999px;background:#fff0f1;color:#c91f2b;font-size:.68rem;font-weight:800}.profile-details{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.9rem 1.2rem}.profile-details article{display:grid;grid-template-columns:36px 1fr;align-items:center;gap:.65rem;min-width:0}.profile-details>article>i{width:36px;height:36px;border-radius:11px;background:#eef2f7;color:var(--cr-navy-soft);display:grid;place-items:center}.profile-details article div{display:grid;min-width:0}.profile-details small{color:#7a8597;font-size:.7rem;text-transform:uppercase}.profile-details strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:.86rem}.profile-button{display:inline-flex;align-items:center;justify-content:center;gap:.5rem;padding:.75rem 1rem;border-radius:12px;background:var(--cr-red);color:var(--cr-white);text-decoration:none;font-weight:800;white-space:nowrap}.today-section{margin-top:2.4rem}.section-heading h2{margin:.3rem 0;font-size:clamp(1.65rem,3vw,2.35rem)}.action-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem;margin-top:1.4rem}.action-card{position:relative;display:grid;grid-template-columns:54px 1fr auto;align-items:center;gap:1rem;min-height:130px;padding:1.2rem;border:1px solid #e1e6ed;border-radius:20px;background:var(--cr-white);color:var(--cr-navy-deep);text-decoration:none;box-shadow:0 10px 25px rgba(1,30,65,.05);transition:.2s}.action-card:hover{transform:translateY(-3px);border-color:var(--cr-red);box-shadow:0 16px 32px rgba(1,30,65,.1)}.action-icon{width:54px;height:54px;border-radius:16px;background:#fff0f1;color:var(--cr-red-muted);display:grid;place-items:center;font-size:1.25rem}.action-card h3{margin:0 0 .3rem;font-size:1.05rem}.action-card p{margin:0;color:var(--cr-gray-500);font-size:.82rem;line-height:1.45}.action-arrow{color:#9aa4b2}.action-card:hover .action-arrow{color:var(--cr-red)}@media(max-width:1200px){.profile-summary{grid-template-columns:1fr 1.3fr}.profile-button{grid-column:1/-1}.action-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:800px){.welcome-hero{align-items:flex-start;flex-direction:column}.profile-summary{grid-template-columns:1fr}.profile-details{grid-template-columns:1fr 1fr}.profile-button{grid-column:auto}.action-grid{grid-template-columns:1fr}}@media(max-width:560px){.welcome-shell{display:block}.welcome-page{padding:1rem}.profile-identity{align-items:flex-start;flex-direction:column}.profile-details{grid-template-columns:1fr}.action-card{grid-template-columns:48px 1fr}.action-arrow{display:none}}
</style>
