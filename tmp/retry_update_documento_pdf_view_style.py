...
if old_header not in text:
    raise SystemExit('No se encontró el bloque de encabezado esperado.')
...
if old_label not in text:
    raise SystemExit('No se encontró el bloque de la columna izquierda esperado.')
...
'''
if old_footer_css not in text:
    raise SystemExit('No se encontró el bloque del pie de página esperado.')
text = text.replace(old_footer_css, new_footer_css, 1)
